...
export function LoginForm({ demoMode }: { demoMode: boolean }) {
  ...
  const [email, setEmail] = useState(demoMode ? "mina@planeo.co" : "");
  const [password, setPassword] = useState(demoMode ? "planeo-demo" : "");
